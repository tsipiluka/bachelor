...
NOCH AUF 2.9 und 2.11 EINGEHEN!!
\subsection{WebAuthn}
...
\begin{figure}[h]
	...
	\captionsetup{format=hang}
	\caption{FIDO2 Darstellung} \label{fido2}
\end{figure}
