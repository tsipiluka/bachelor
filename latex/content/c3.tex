...
Es agiert dabei als Interface für mehrere Anwendung und ermöglicht es dem Nutzer, diese Anwendungen zu starten. Welche Anwendungen sichtbar sind, können je nach Kunde individuell konfiguriert werden. Ein Beispiel für ein solches Startportal wird in \textbf{\ref{cFront}} dargestellt.
\begin{figure}[h]
	\centering 
